...
{
    private final List<Integer> coinSortBuffer  = new ArrayList<>();
    
    private int[] coinRoller;
    
    private int pennies = 0;
    private int penniesRolls = 0;
    private double penniesTot = 0.0;
    private int nickels = 0;
    private int nickelsRolls = 0;
    private double nickelsTot = 0.0;
    private int dimes = 0;
    private int dimesRolls = 0;
    private double dimesTot = 0.0;
    private int quarters = 0;
    private int quartersRolls = 0;
    private double quartersTot = 0.0;
    ...
    {
        File inputFile = new File ("G:\\School\\Fall 2015\\Contemporary-Programming-Languages\\P2main\\src\\p2main\\input.txt");
    ...
    {
        PrintWriter out = new PrintWriter(new FileWriter("G:\\School\\Fall 2015\\Contemporary-Programming-Languages\\P2main\\src\\p2main\\output.txt"));
        ...
        out.print(penniesRolls + " roll(s) of pennies + " + pennies + " pennies    = $" + penniesTot + "\n");
        out.print(nickelsRolls + " roll(s) of nickels + " + nickels + " nickels    = $" + nickelsTot + "\n");
        out.print(dimesRolls + " roll(s) of dimes + " + dimes + " dimes         = $" + dimesTot + "\n");
        out.print(quartersRolls + " roll(s) of quarters + " + quarters + " quarters   = $" + quartersTot + "\n");
